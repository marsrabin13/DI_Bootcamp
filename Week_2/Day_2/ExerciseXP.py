...
favorite_book("Kitchen God's Wife")
...
import random
def compare_random_num(a):
    b = random.randint(1, 100)
    if a == b:
        print("Success! your numbers match")
    else:
        print(f"Fail! Your number: {a}, Random number: {b}.")
...
def make_shirt(size='large',text='I love Python'):
    print(f"The shirt size: {size} and the text {text}.")
...
make_shirt(size='medium',text='I hate you')
# Expected Output:
...
def make_great(magician_names):
    for magician in magician_names:
        ...
        new_magician_names.append(magician)
